...
{
   public int Write(ref BufferWriter<byte> writer, scoped in DateTimeOffset value)
   {
   ...
   public bool TryRead(ref SequenceReader<byte> reader, out DateTimeOffset value)
   {
   ...
   public int CalculateByteLength(scoped in DateTimeOffset value)
   {
      return sizeof(long) * 2;
   }
}
